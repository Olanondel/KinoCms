...
<script>
import RadioWithButtonAndText from "../../components/admin/mailing/RadioWithButtonAndText";
...
import server from '../../requests/admin/mailing'
...
export default {
  ...
  methods: {
    ...
    startSmsMailing() {
      if (this.sms === "all" && this.smsText.length) {
    ...
    startMailMailing() {
      if (this.email === "all") {
        console.log('mailing with email was started!')
      } else {
